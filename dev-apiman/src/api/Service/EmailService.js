...
class EmailService {
  ...
  // --------------------------------------------Email for join group -------------------------------


  async sendEmailToUserJoingroup(email, seq_otp) {
  ...
  async sendEmailToExpertjoingroup(email, seq_otp) {
  ...
  async sendEmailToUserJoingroupbooked(email, seq_otp) {
  ...
  async sendEmailToExpertjoingroupbooked(email, seq_otp) {
