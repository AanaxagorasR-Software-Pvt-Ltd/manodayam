...
async sendEmailToPlanebooked(email, details, startDate) {
  console.log("sendEmailtoUser")
  let info = await this.transporter.sendMail({
    to: email,
    from: `manodayam.swayamshakthi@gmail.com`,
...
// ------------------------------------------------------------------Email send to scheduler-----------------------------------------------------
async sendEmailToscheduler(details) {
  console.log("sendEmailtoUser")
  let info = await this.transporter.sendMail({
    to: details.user.email,
    from: `manodayam.swayamshakthi@gmail.com`,
    subject: "Hello Your Subscription is on active ",
    // alternatives: [{ contentType: "text/html" }],
    html: ` 
...
// _id: 62b05130ba77792b90d8f4f8,
//     id: 62a71ea982390200f0172953,
//     email: 'yogitanegi888@gmail.com',
//     createdAt: '2022-06-20',
//     endDate: '2022-07-31',
//     status: 'booked',
//     subscription: {
//       _id: 62a71ea982390200f0172953,
//       type: 'Depression',
//       therapy: 's',
//       selfassessment: 's',
//       doctorassessment: '6229d6766d7f39ddbd3458de',
//       totalassessment: '10',
//       grouptherapy: 's',
//       meditation: 's',
//       benefitsdescription: 's',
//       schedule: '6-week',
//       price: '888',
//       created: '2022-06-13'
//     },
//     user: {
//       _id: 62a337cb4b3b882eacf3269a,
//       name: 'yogita',
//       email: 'yogitanegi888@gmail.com',
//       password: '$2b$10$cLJ7OeD1O6hYrLMdRRaQ2OYH33ySf9AAzkkKQDCZq6td71mbEjJ32'
//     },
//     doctorId: 6229d6766d7f39ddbd3458de,
//     doctorListing: {
//       _id: 6229d6766d7f39ddbd3458de,
//       name: 'Dr. Nand',
//       experience: '7 years',
//       specialist: 'Anxiety specialist',
//       email: 'jyotipatel2138@gmail.com\t',
//       img_url: 'https://swarnratnaindia.com/dev-apiman/uploads/images/img_url_1646932305979.png',
//       created: '2022-03-10',
      ...
      <body style="box-sizing: border-box;margin: 0;font-family: -apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,Roboto,&quot;Helvetica Neue&quot;,Arial,&quot;Noto Sans&quot;,&quot;Liberation Sans&quot;,sans-serif,&quot;Apple Color Emoji&quot;,&quot;Segoe UI Emoji&quot;,&quot;Segoe UI Symbol&quot;,&quot;Noto Color Emoji&quot;;font-size: 1rem;font-weight: 400;line-height: 1.5;color: #212529;text-align: left;background-color: #fff;min-width: 992px!important;">
        ...
        <div class="card" style="width: 24rem;box-sizing: border-box;position: relative;display: flex;-ms-flex-direction: column;flex-direction: column;min-width: 0;word-wrap: break-word;background-color: #fff;background-clip: border-box;border: 1px solid rgba(0,0,0,.125);border-radius: .25rem;">
          ...
          <div class="card-body" style="box-sizing: border-box;-ms-flex: 1 1 auto;flex: 1 1 auto;min-height: 1px;padding: 1.25rem;">
            <h5 class="card-title" style="box-sizing: border-box;margin-top: 0;margin-bottom: .75rem;font-weight: 500;line-height: 1.2;font-size: 1.25rem;">Vedio meeting</h5>
            <p class="card-text font-italic text-info" style="box-sizing: border-box;margin-top: 0;margin-bottom: 1rem;orphans: 3;widows: 3;font-style: italic!important;color: #17a2b8!important;"> Hello Doctor ! We Would  like to inform you that we have booked  your schedule  on 
            <strong style="box-sizing: border-box;font-weight: bolder;">${details.createdAt} </strong>. please acknowledge this appointment !! your patient name  is <strong style="box-sizing: border-box;font-weight: bolder;">${details.user.name} </strong> and Problem statement  <strong style="box-sizing: border-box;font-weight: bolder;">${details.subscription.type}</strong>
