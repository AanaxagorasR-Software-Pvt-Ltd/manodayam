...
import voiceAssessmentQuestion from "../Store/Connect/voiceAssessmentQuestion";
...
const VoiceAssessment = () => {
  ...
  const deleteData = (_id) => {
    voiceAssessmentQuestion.delete(_id).then((res) => {
      // alert(res?.message);
            ...
            <div class="content-wrapper">
              <div class="row">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Voice Assessment Questions</h4>
...
const Addform = forwardRef((props, ref) => {
  ...
  return (
    <>
      ...
      >
        <Modal.Header>
          <Modal.Title>Add Voice Assessment Questions</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <form class="forms-sample">
            <div class="form-group">
