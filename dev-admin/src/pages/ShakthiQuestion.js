import React, {
  ...
  import shakthiQues from "../Store/Connect/shakthiQues";
  // let Button = new AA()
  
  const SpiritualityQuestion = () => {
    ...
    const deleteData = (_id) => {
      shakthiQues.delete(_id).then((res) => {
        alert(res?.message);
        list();
      });
    };
              ...
              <div class="content-wrapper">
                <div class="row">
                  ...
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h4 class="card-title">Shakthi Questions</h4>
  ...
  export default SpiritualityQuestion;
