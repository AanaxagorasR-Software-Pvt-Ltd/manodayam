...
import mastercategory from "../Store/Services/mastercategory";
...
const MasterCategory = () => {
  ...
  const deleteCat = (_id) => {
    mastercategory.delete(_id).then((res) => {
      // console.log('res', res);
      // alert(res?.message);
...
const Addform = forwardRef((props, ref) => {
  ...
  return (
    <>
      ...
      >
        <Modal.Header>
          <Modal.Title>Add Master Category</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <form class="forms-sample">
            <div class="form-group">
              <label for="exampleInputUsername1">Master Category Name</label>
              <input
                type="text"
                class="form-control"
                value={data.mastercategory || ""}
                onChange={(e) => {
                  handleChange(e.target.value, "mastercategory");
                }}
                placeholder="mastercategory  here"
              />
            </div>

            <div class="form-group ">
              <label for="exampleInputUsername1">Master Category Status</label>
              <select
                class="form-control"
                value={data.status || ""}
                onChange={(e) => {
