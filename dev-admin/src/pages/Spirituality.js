...
import spirituality from "../Store/Services/spirituality";
...
const Spirituality = () => {
  ...
  const deleteCat = (_id) => {
    spirituality.delete(_id).then((res) => {
      // console.log('res', res);
      alert(res?.message);
      list();
    });
            ...
            <div class="content-wrapper">
              <div class="row">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Spirituality list</h4>
                      <div class="table-responsive pt-3">
                        <table class="table table-bordered">
                          <thead>
                            <tr>
                              <th>S.No</th>
                              <th>Spirituality Image </th>

                              <th>Spirituality Name </th>
                              <th> Description </th>
...
const Addform = forwardRef((props, ref) => {
  ...
  return (
    <>
      ...
      >
        <Modal.Header>
          <Modal.Title>Add Spirituality</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <form class="forms-sample">
            <div class="form-group">
              <label for="exampleInputUsername1">Spirituality Name</label>
              <input
                type="text"
                class="form-control"
                value={data.name || ""}
                ...
                placeholder="Spirituality Name"
              />
            </div>
            <div class="form-group">
              <label for="exampleInputUsername1">Spirituality description</label>
              <input
                type="text"
                class="form-control"
                ...
                placeholder="Spirituality description"
              />
            </div>
            <div class="form-group">
              <label for="exampleInputUsername1">Spirituality Image</label>
              <input
                type="file"
                class="form-control"
                // file={data.img || ""}
            ...
            <div class="form-group ">
              <label for="exampleInputUsername1">Spirituality Status</label>
              <select
                class="form-control"
                value={data.status || ""}
                onChange={(e) => {
