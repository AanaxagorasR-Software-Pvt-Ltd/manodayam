			...
			<div class="main-sidebar main-sidebar-sticky side-menu">
				...
				<div class="main-sidebar-body">
					<ul class="nav">
						...
						<li class="nav-item">
							<Link class="nav-link " to="home"><i class="fas fa-home"></i><span class="sidemenu-label">Home</span></Link>
						</li>
						<li class="nav-item">
							<Link class="nav-link " to="sleep"><i class="fas fa-bed"></i><span class="sidemenu-label">Sleep</span></Link>
						</li>
						<li class="nav-item">
							<Link class="nav-link " to="meditate"><i class="fas fa-om"></i><span class="sidemenu-label">Meditate</span></Link>
						</li>
						<li class="nav-item">
							<Link class="nav-link " to="music"><i class="fas fa-music"></i><span class="sidemenu-label">Music</span></Link>
						</li>
						<li class="nav-item">
							<Link class="nav-link " to="masterclass"><i class="fas fa-lightbulb"></i><span class="sidemenu-label">Masterclass</span></Link>
						</li>
						<li class="nav-item">
							<Link class="nav-link " to="body"><i class="fas fa-child"></i><span class="sidemenu-label">Body</span></Link>
						</li>
						<li class="nav-item">
							<Link class="nav-link " to="scene"><i class="fas fa-sun"></i><span class="sidemenu-label">Scenes</span></Link>
						</li>
						<li class="nav-item">
							<Link class="nav-link " to="profile"><i class="fas fa-user"></i><span class="sidemenu-label">Profile</span></Link>
						</li>
